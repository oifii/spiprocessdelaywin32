///////////////////////////////////////////////////////////////
// spiprocessdelaywin32.cpp : Defines the entry point for the application.
//
//delay, maxed out to 60 sec
//
...
///////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "spiprocessdelaywin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spiprocessdelaywin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spiprocessdelaywin32class"};				// the main window class name
...
static int delayCallback( const void *inputBuffer, void *outputBuffer,
                         unsigned long framesPerBuffer,
                         const PaStreamCallbackTimeInfo* timeInfo,
                         PaStreamCallbackFlags statusFlags,
                         void *userData );
                         ...
                         void *userData )
{
    ...
    else
    {
        for( i=0; i<framesPerBuffer; i++ )
        {
            ...
            *out++ = *in++;          // right - clean 
			*/
            *out++ = delayline(*in++);          // left - clean 
            *out++ = delayline(*in++);          // right - clean 
        }
    }
                     ...
                     int       nCmdShow)
{
	...
	if(nArgs>7)
	{
		global_delay_ms = atoi(szArgList[7]); //maxed out to 60000 for 60 sec of sample data
	}
	M = SAMPLE_RATE*global_delay_ms/1000;
	if(nArgs>8)
	{
